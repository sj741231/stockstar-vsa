        ...
        if (res != 0) and (len(res) != 0):
            ...
            if host['status'] == '1':
                print "\t", "\033[1;31;40m%s\033[0m" % "Host_IP:", "\033[1;31;40m%s\033[0m" % host['host'].ljust(
                    15), '\t', "\033[1;31;40m%s\033[0m" % "Host_Name:", "\033[1;31;40m%s\033[0m" % host[
                    'name'], '\t', "\033[1;31;40m%s\033[0m" % u'未在监控状态'
                return host['hostid']
            elif host['status'] == '0':
                print "\t", "\033[1;32;40m%s\033[0m" % "Host_IP:", "\033[1;32;40m%s\033[0m" % host['host'].ljust(
                    15), '\t', "\033[1;32;40m%s\033[0m" % "Host_Name:", "\033[1;32;40m%s\033[0m" % host[
                    'name'], '\t', "\033[1;32;40m%s\033[0m" % u'在监控状态'
                return host['hostid']
            print
        else:
...
def main():
    test = zabbixtools()
    a= test.host_get('10.99.12.130')
    print test.template_get()
